...
<p>This is a notice that a unpaid invoice on {SITENAME} has been marked for a "<span
            style='color: #b20000;'>discount</span>".</p>
...
<p>
    The invoice was retracted to unpaid status possibly due to a refund or other agreement.<br><br>
