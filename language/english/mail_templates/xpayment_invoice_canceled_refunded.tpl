...
<p>This is a notice that an invoice on {SITENAME} which was previously marked as "<span
            style='color: #b20000;'>canceled</span>" has now been marked as "<span style='color: #b20000;'>refunded</span>".
</p>
