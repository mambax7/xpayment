 ...
 * @access 		public
 */
class XoopsFormSelectPlugin extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPlugin($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$plugins = XoopsLists::getFileListAsArray($GLOBALS['xoops']->path('/modules/xpayment/plugin/'));
