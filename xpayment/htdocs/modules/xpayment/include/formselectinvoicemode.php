 ...
 * @access 		public
 */
class XoopsFormSelectInvoiceMode extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectInvoiceMode($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        foreach(array('PAID', 'CANCEL', 'UNPAID') as $mode)
