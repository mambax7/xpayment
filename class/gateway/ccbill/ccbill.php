...
class CcbillGatewaysPlugin
{
    ...
    public function __construct($invoice, $gateway)
    {
        ...
        if (file_exists($GLOBALS['xoops']->path('modules/xpayment/language/' . $GLOBALS['xoopsConfig']['language'] . '/ccbill.php'))) {
            require_once $GLOBALS['xoops']->path('modules/xpayment/language/' . $GLOBALS['xoopsConfig']['language'] . '/ccbill.php');
        } else {
            require_once $GLOBALS['xoops']->path('modules/xpayment/language/english/ccbill.php');
        }
    }

    public function returnISOCurr($numeric)
    {
    ...
    public function returnNUMCurr($isocode)
    {
        foreach ($this->_currcode as $iso => $code) {
            if ($isocode == $iso) {
                return $code;
    ...
    public function goInvoiceObj()
    {
        ...
        return $invoiceHandler->get(CcbillGatewaysPlugin::getInvoice());
    }
