...
if (!function_exists('fraudQuery')) {
    function fraudQuery($ip, $country_code, $district, $city, $area_code, $mail_domain, $apikey)
    {
        ...
        return array(
            ...
            'fraud_ipdb_districtcity'  => $answer->DistrictCity,
            'fraud_ipdb_ipcountrycode' => $answer->IpCountryCode,
            'fraud_ipdb_ipcountry'     => $answer->IpCountry,
            'fraud_ipdb_ipregioncode'  => $answer->IpRegionCode,
            'fraud_ipdb_ipregion'      => $answer->IpRegion,
            'fraud_ipdb_ipcity'        => $answer->IpCity,
            'IpHostName'               => $answer->IpHostName,
