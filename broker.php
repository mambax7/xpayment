...
if (!in_array($GLOBALS['xoopsModuleConfig']['brokers'], $GLOBALS['xoopsUser']->getGroups())) {
    redirect_header(XOOPS_URL . '/modules/xpayment/index.php', 3, _NOPERM);
    exit(0);
}
    ...
    case 'invoices':
        switch ($_REQUEST['fct']) {
            ...
            case 'list':
                ...
                $criteria = new CriteriaCompo(new Criteria('broker_uids', '%"' . $GLOBALS['xoopsUser']->getVar('uid') . '"%', 'LIKE'));
